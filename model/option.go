...
func InitOptionMap() {
	...
	common.OptionMap["TaskPluginPageEnabled"] = strconv.FormatBool(constant.TaskPluginPageEnabled)
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" {
		...
		case "TaskPluginPageEnabled":
			constant.TaskPluginPageEnabled = boolValue

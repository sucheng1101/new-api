...
func channelAffinityUsageCacheTestValue(prefix string) string {
...
func TestObserveChannelAffinityUsageCacheByRelayFormat_ClaudeMode(t *testing.T) {
	ruleName := channelAffinityUsageCacheTestValue("rule")
	usingGroup := "default"
	keyFP := channelAffinityUsageCacheTestValue("fp")

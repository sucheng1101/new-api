...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.GET("/perf-metrics/summary", middleware.TryUserAuth(), controller.GetModelPerformanceSummary)
		apiRouter.GET("/perf-metrics", middleware.TryUserAuth(), controller.GetModelPerformance)
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.GET("/usage/batch", controller.GetChannelUsageBatch)
